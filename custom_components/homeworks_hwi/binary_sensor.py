...
class HomeworksLEDBinarySensor(
    ...
    async def async_will_remove_from_hass(self) -> None:
        ...
        # Do NOT unregister the shared KLS poll address here.
        # Other LED sensors on the same keypad still need it.
        # The address is cleaned up when the entire keypad is removed.
